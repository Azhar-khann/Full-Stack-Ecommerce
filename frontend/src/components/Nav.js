            ...
            <div className="container-fluid ">
              ...
              <div className="collapse navbar-collapse justify-content-between" id="navbarNavDropdown">
                  ...
                  <ul className="navbar-nav " style={{marginRight: '1%'}}>
                    ...
                    <li className="nav-item">
                      {LoggedIn ? (
                        <Link to={'/'} style={{ textDecoration: 'none' }} className="nav-link" aria-current="page">
                    ...
                    <li className="nav-item py-1 ">
                      <NavLink className="nav-link cart_icon" href="#">
                          <svg xmlns="http://www.w3.org/2000/svg" style={{color: 'var(--bs-nav-link-color)'}} width="20" height="30" fill="currentColor" className="bi bi-bag" viewBox="0 0 16 16">
